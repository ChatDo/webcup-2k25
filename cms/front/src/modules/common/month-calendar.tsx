// TODO: FIX "Comp is not a function" & ADD JS TO HANDLE THE CALENDAR
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-4 md:flex md:items-center">
                        <Menu as="div" class="relative">
                            ...
                            <MenuItems
                                transition
                                class="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden data-closed:scale-95 data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                            >
                                <div class="py-1">
                                    <MenuItem>
                                        <a
                                            href="#"
                                            class="block px-4 py-2 text-sm text-gray-700 data-focus:bg-gray-100 data-focus:text-gray-900 data-focus:outline-hidden"
                                        >
                                            Day view
                                        </a>
                                    </MenuItem>
                        ...
                        <button
                            type="button"
                            class="ml-6 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                        >
                            Add event
                        </button>
                    </div>
                    <Menu as="div" class="relative ml-6 md:hidden">
                        ...
                        <MenuItems
                            transition
                            class="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-gray-100 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-hidden data-closed:scale-95 data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                        >
                            <div class="py-1">
                                <MenuItem>
                                    <a
            ...
            <div class="shadow-sm ring-1 ring-black/5 lg:flex lg:flex-auto lg:flex-col">
                ...
                <div class="flex bg-gray-200 text-xs/6 text-gray-700 lg:flex-auto">
                            ...
                            >
                                ...
                                {day.events.length > 0 && (
                                    <ol class="mt-2">
                                        ...
                                        {day.events.length > 2 && <li class="text-gray-500">+ {day.events.length - 2} more</li>}
                                    </ol>
                                )}
                            </div>
                        ))}
                    ...
                    {day.events.map((event) => (
                        <span key={event.id} class="mx-0.5 mb-1 size-1.5 rounded-full bg-gray-400" />
                    ))}
                  </span>
                                )}
                            </button>
                ...
                <div class="px-4 py-10 sm:px-6 lg:hidden">
                    <ol class="divide-y divide-gray-100 overflow-hidden rounded-lg bg-white text-sm shadow-sm ring-1 ring-black/5">
                        {selectedDay.events.map((event) => (
                            <li key={event.id} class="group flex p-4 pr-6 focus-within:bg-gray-50 hover:bg-gray-50">
                                <div class="flex-auto">
